...
def SeismicModelZeroincidentAngle(Vp, Rho,theta, wavelet):
...
def SeismicModelZeroincidentAngleTorch(Vp, Rho,theta,W):
    ...
    #Seis1 = torch.tensor(Seis.T)#.float()
